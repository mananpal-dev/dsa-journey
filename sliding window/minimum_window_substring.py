...
# Approach:
# Use a sliding window and maintain character counts.
# Expand the window until all characters of t are covered.
...
# Common Mistake:
# Shrinking the window before ensuring all required
# characters are present.

# Revision Note:
# Classic Sliding Window problem.
# Important pattern: Expand -> Satisfy Condition -> Shrink.
